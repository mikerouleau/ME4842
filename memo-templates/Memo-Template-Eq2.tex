...
%----This template includes equation numbering BELOW the equation----%
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.4]{"COUNSEL--PLAINTIFF-YEAMES-1-C30497".jpg}%include full file path unless source file is in the same directory.
\caption{Counsel \& Plaintiff (Yeames)\cite{Herbert}}\label{fig:Cat Lord}
\end{figure}
